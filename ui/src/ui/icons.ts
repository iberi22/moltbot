...
export const icons = {
  ...
  cloud: html`<svg viewBox="0 0 24 24"><path d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.2-3.9-4.5-1.1-3.3-4.1-5.5-7.6-5.5-4.1 0-7.5 3.1-7.9 7.1-1.3.4-2.1 1.7-2.1 3.1 0 1.8 1.5 3.3 3.3 3.3h13.7z"/></svg>`,
